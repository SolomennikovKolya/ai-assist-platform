...
<template>
  ...
  <svg v-if="name === 'horizontal'" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-if="name === 'vertical'" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-if="name === 'upload-from-file'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
      fill="currentColor"
      d="M12 9l-4 4l1.4 1.4l1.6-1.55V17h2v-4.15l1.6 1.55L16 13l-4-4zM6 22q-.825 0-1.412-.587Q4 20.825 4 20V8l6-6h8q.825 0 1.413.588Q20 3.175 20 4v16q0 .825-.587 1.413Q18.825 22 18 22zm0-2h12V4h-7.15L6 8.85z"
    />
  </svg>

  <svg v-else-if="name === 'save-to-file'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
      fill="currentColor"
  ...
  <svg v-if="name === 'upload-from-ls'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
  ...
  <svg v-if="name === 'save-to-ls'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
  fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"> 
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /> 
